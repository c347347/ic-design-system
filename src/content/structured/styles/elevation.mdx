...
| --ic-z-index-page-header                                               | [Page header](/components/page-header)                                                                     | Base + 10              |
| --ic-z-index-back-to-top                                               | [Back to top](/components/back-to-top)                                                                     | Base + 20              |
| --ic-z-index-menu                                                      | Menu for [select](/components/select) and [search bar](/components/search-bar)                             | Base + 50              |
| --ic-z-index-popover                                                   | Popover menu                                                                                               | Base + 50              |
| --ic-z-index-navigation-item                                           | Navigation item used in [top navigation](/components/top-nav) and [side navigation](/components/side-nav). | Base + 50              |
| --ic-z-index-navigation-menu                                           | Navigation menu used in [top navigation](/components/top-nav) at smaller breakpoints.                      | Base + 60              |
| --ic-z-index-side-navigation                                           | [Side navigation](/components/side-nav)                                                                    | Base + 60              |
| --ic-z-index-dialog                                                    | Dialog                                                                                                     | Base + 100             |
| --ic-z-index-tooltip                                                   | [Tooltip](/components/tooltip)                                                                             | Base + 110             |
| --ic-z-index-classification-banner                                     | [Classification banner](/components/classification-banner)                                                 | Base + 200             |
...
Additionally users can change the z-index value for a specific token, affecting a specific component, either globally:
